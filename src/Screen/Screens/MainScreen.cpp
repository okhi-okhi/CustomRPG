...
MainScreen::MainScreen() : Screen(ScreenType::MAIN, "main")
{
	...
	addElementGroup(make_shared<ButtonText>(Vector2(960, 324), Button(buttonBg, openSelectGame), Text("screen.main.button1", 48, TextAlign::LEFT, WHITE, 0.0f)));
	addElementGroup(make_shared<ButtonText>(Vector2(960, 540), Button(buttonBg, openSetting), Text("screen.main.button2", 48, TextAlign::LEFT, WHITE, 0.0f)));
	addElementGroup(make_shared<ButtonText>(Vector2(960, 756), Button(buttonBg, closeWindow), Text("screen.main.button3", 48, TextAlign::LEFT, WHITE, 0.0f)));
}
