...
{
	const std::string path = PathProvider::instance().getScreensPath();
	addElement(FullPicture(path + "main/background.png", 1));
	addButton(Button(path + "basic_button.png", Vector2(0.5f, 0.2f), 0.1f, "screen.test.button1", 0.03f, textAlign::CENTER, BLACK, 0.0f, test));
	addButton(ButtonArg(path + "basic_button.png", Vector2(0.5f, 0.5f), 0.1f, "screen.test.button2", { {"aa", &playerDistance} }, 0.03f, textAlign::CENTER, BLACK, 0.0f, test));
	...
	addButton(Button(path + "basic_button.png", Vector2(0.1f, 0.2f), 0.1f, "screen.test.button1", 0.03f, textAlign::CENTER, BLACK, 0.0f, test));
}
